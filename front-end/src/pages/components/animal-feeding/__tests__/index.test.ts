describe("Test 'AnimalFeeding'", () => {
  test('Should render in expected order the child components of the parent component - container', () => {
    /**
  ...
  test('Button component should render router link component with expected props and label', () => {
    /**
     * TODO: missing test due to lack of developer time
     *
     * assert(returned).toEqual(expected)
